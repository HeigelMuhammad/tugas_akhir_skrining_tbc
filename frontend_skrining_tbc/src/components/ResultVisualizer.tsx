...
export function ResultVisualizer({ data }: { data: ResultProps }) {
  ...
  return (
    <div className="space-y-4 mt-6 animate-in fade-in zoom-in duration-500">
            {/* Kotak transparansi matematika */}
      <Card className="border">
        <CardContent className="pt-5">
          ...
          <p className="mb-5 text-xs text-muted-foreground">
            AI mengolah suara melalui 3 tahap matematika untuk menghasilkan probabilitas akhir
            menggunakan arsitektur {data.algoritma}.
          </p>
          ...
          <div className="mt-4 flex items-start gap-2.5 rounded-xl border border-primary/20 bg-primary/5 px-4 py-3">
            ...
            <p className="text-xs leading-relaxed text-primary/80">
              ...
              kategori tersebut. Hasil ini bukan diagnosis medis resmi — selalu konsultasikan
              ke dokter untuk tindak lanjut.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      >
        <div
          className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-full ${
            isSuspect ? "bg-red-50" : "bg-green-50"
          }`}
        >
          {isSuspect ? (
        ...
        <div className="flex-1">
          <p className="text-xs text-muted-foreground">Hasil deteksi AI</p>
          <p
            className={`text-xl font-semibold ${
              isSuspect ? "text-red-600" : "text-green-600"
            }`}
          >
            {data.diagnosis}
          </p>
              ...
              >
                <span
                  className={`h-1.5 w-1.5 rounded-full ${
                    isSuspect ? "bg-red-500" : "bg-green-500"
                  }`}
                />
